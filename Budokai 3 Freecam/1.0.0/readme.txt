...
[Numpad1] 		= Camera Move Gradually
[Numpad2] 		= Invert X Axis
[Numpad3] 		= Invert Y Axis
[Numpad4] 		= Hide HUD by default (hide the hud when freecam toggled on)
[Numpad5] 		= Pause Game by default (pause the game when freecam toggled on)
[Numpad6] 		= Toggle 50/60 Hz Refresh Rate (this option is useful for games that support PAL-60Hz refresh rate)
